...
namespace Operation
{
    public partial class PDD : Form
    {
        ...
        public PDD()
        {
            ...
            webBrowser2 = new ChromiumWebBrowser("https://mms.pinduoduo.com/Pdd.html#/index");
        ...
        private void btn_addjs_Click(object sender, EventArgs e)
        {
            ...
            //设置推广计划里的数据,不显示滚动条
            Browser.JS_CEFBrowser_NoReturn("document.getElementsByClassName('ant-table-scroll')[0].classList.remove('ant-table-scroll')", webBrowser2);
            Browser.JS_CEFBrowser_NoReturn("document.getElementsByClassName('ant-table-body')[0].style=''", webBrowser2);
        }
        #endregion
