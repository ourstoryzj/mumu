...
namespace Common
{
    ...
    public static string MyUrlDeCode(string str, Encoding encoding)
    {
     ...
     return HttpUtility.UrlDecode(str, encoding); 
        ...
        /// </summary>
        /// <param name="str"></param>
        public static string ToClearHtml(this string html)
        {
            //string strText = System.Text.RegularExpressions.Regex.Replace(html, "<[^>]+>", "");
            //strText = System.Text.RegularExpressions.Regex.Replace(strText, "&[^;]+;", "");

            html = Zxj_ReplaceHtml("&#[^>]*;", "", html);
            html = Zxj_ReplaceHtml("</?marquee[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?object[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?param[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?embed[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?table[^>]*>", "", html);
            html = Zxj_ReplaceHtml(" ", "", html);
            html = Zxj_ReplaceHtml("</?tr[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?th[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?p[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?a[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?img[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?tbody[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?li[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?span[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?div[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?th[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?td[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?script[^>]*>", "", html);
            html = Zxj_ReplaceHtml("(javascript|jscript|vbscript|vbs):", "", html);
            html = Zxj_ReplaceHtml("on(mouse|exit|error|click|key)", "", html);
            html = Zxj_ReplaceHtml("<\\?xml[^>]*>", "", html);
            html = Zxj_ReplaceHtml("<\\/?[a-z]+:[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?font[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?b[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?u[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?i[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?strong[^>]*>", "", html);
            html = Zxj_ReplaceHtml("</?strong[^>]*>", "", html);
...
        }
        ...
        public static void EmailSend(string email, string title, string content,string account="ourstoryzj@163.com",string pwd="zj013368qw")
        {
            try
            {
                ...
                mm.From = new MailAddress(account, title, Encoding.GetEncoding(936));
                //收件方看到的邮件来源；
                //第一个参数是发信人邮件地址
                //第二参数是发信人显示的名称
        ...
        public static Image ClipboardGetImgFromHTML()
        {
            ...
            if (Clipboard.ContainsData(DataFormats.Html))
            {
                ...
                string[] res = HTMLHelper.GetHtmlImageUrlList(html);
                string ss = res[0];
