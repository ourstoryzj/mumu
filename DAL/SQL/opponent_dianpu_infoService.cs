...
namespace DAL
{
    ...
    public class opponent_dianpu_infoService : Iopponent_dianpu_infoService
    {
        ...
        public static SqlParameter[] GetSqlParameters(opponent_dianpu_info opponent_dianpu_infoExample)
        {
            List<SqlParameter> list_param = new List<SqlParameter>();
            if (opponent_dianpu_infoExample.odigoodsnum != 0)
            {
                list_param.Add(new SqlParameter("@odigoodsnum", opponent_dianpu_infoExample.odigoodsnum));
            }
            else
            {
                list_param.Add(new SqlParameter("@odigoodsnum", DBNull.Value));
            }
            if (opponent_dianpu_infoExample.odisell0 != 0)
            {
                list_param.Add(new SqlParameter("@odisell0", opponent_dianpu_infoExample.odisell0));
            }
            else
            {
                list_param.Add(new SqlParameter("@odisell0", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odiSKUcount))
            {
                list_param.Add(new SqlParameter("@odiSKUcount", opponent_dianpu_infoExample.odiSKUcount));
            }
            else
            {
                list_param.Add(new SqlParameter("@odiSKUcount", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odipricehigh))
            {
                list_param.Add(new SqlParameter("@odipricehigh", opponent_dianpu_infoExample.odipricehigh));
            }
            else
            {
                list_param.Add(new SqlParameter("@odipricehigh", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odipricelowset))
            {
                list_param.Add(new SqlParameter("@odipricelowset", opponent_dianpu_infoExample.odipricelowset));
            }
            else
            {
                list_param.Add(new SqlParameter("@odipricelowset", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odipriceaverage))
            {
                list_param.Add(new SqlParameter("@odipriceaverage", opponent_dianpu_infoExample.odipriceaverage));
            }
            else
            {
                list_param.Add(new SqlParameter("@odipriceaverage", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odisellhigh))
            {
                list_param.Add(new SqlParameter("@odisellhigh", opponent_dianpu_infoExample.odisellhigh));
            }
            else
            {
                list_param.Add(new SqlParameter("@odisellhigh", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odiselllowset))
            {
                list_param.Add(new SqlParameter("@odiselllowset", opponent_dianpu_infoExample.odiselllowset));
            }
            else
            {
                list_param.Add(new SqlParameter("@odiselllowset", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odisellaverage))
            {
                list_param.Add(new SqlParameter("@odisellaverage", opponent_dianpu_infoExample.odisellaverage));
            }
            else
            {
                list_param.Add(new SqlParameter("@odisellaverage", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odisalescount))
            {
                list_param.Add(new SqlParameter("@odisalescount", opponent_dianpu_infoExample.odisalescount));
            }
            else
            {
                list_param.Add(new SqlParameter("@odisalescount", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odisellcount))
            {
                list_param.Add(new SqlParameter("@odisellcount", opponent_dianpu_infoExample.odisellcount));
            }
            else
            {
                list_param.Add(new SqlParameter("@odisellcount", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odidongxiao))
            {
                list_param.Add(new SqlParameter("@odidongxiao", opponent_dianpu_infoExample.odidongxiao));
            }
            else
            {
                list_param.Add(new SqlParameter("@odidongxiao", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odibaozhangjin))
            {
                list_param.Add(new SqlParameter("@odibaozhangjin", opponent_dianpu_infoExample.odibaozhangjin));
            }
            else
            {
                list_param.Add(new SqlParameter("@odibaozhangjin", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odiDSRmiaoshu))
            {
                list_param.Add(new SqlParameter("@odiDSRmiaoshu", opponent_dianpu_infoExample.odiDSRmiaoshu));
            }
            else
            {
                list_param.Add(new SqlParameter("@odiDSRmiaoshu", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odiDSRzhiliang))
            {
                list_param.Add(new SqlParameter("@odiDSRzhiliang", opponent_dianpu_infoExample.odiDSRzhiliang));
            }
            else
            {
                list_param.Add(new SqlParameter("@odiDSRzhiliang", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.odiDSRwuliu))
            {
                list_param.Add(new SqlParameter("@odiDSRwuliu", opponent_dianpu_infoExample.odiDSRwuliu));
            }
            else
            {
                list_param.Add(new SqlParameter("@odiDSRwuliu", DBNull.Value));
            }
            if (opponent_dianpu_infoExample.odpid != 0)
            {
                list_param.Add(new SqlParameter("@odpid", opponent_dianpu_infoExample.odpid));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@ocollectdate", opponent_dianpu_infoExample.ocollectdate));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@oshopid", opponent_dianpu_infoExample.oshopid));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@oremark1", opponent_dianpu_infoExample.oremark1));
            }
            else
            {
                list_param.Add(new SqlParameter("@oremark1", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.oremark2))
            {
                list_param.Add(new SqlParameter("@oremark2", opponent_dianpu_infoExample.oremark2));
            }
            else
            {
                list_param.Add(new SqlParameter("@oremark2", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(opponent_dianpu_infoExample.oremark3))
            {
                list_param.Add(new SqlParameter("@oremark3", opponent_dianpu_infoExample.oremark3));
            }
            else
            {
                list_param.Add(new SqlParameter("@oremark3", DBNull.Value));
            }
        ...
        public static opponent_dianpu_info GetByReader(SqlDataReader Reader)
        {
