...
namespace DAL
{
    ...
    public class aotunew_titleService : Iaotunew_titleService
    {
        ...
        public IList<aotunew_title> Search(int s, int e, string key, string type1, string type2, DateTime dt1_add, DateTime dt2_add, string orderby)
        {
            string sql1 = "select  top " + (e - s + 1).ToString() + " *   from aotunew_title where ";
            string sql2 = string.IsNullOrEmpty(key) ? " 1=1 " : " (  attitle like '%" + key + "%' or  atjieshao like '%" + key + "%'  or  atremark1 like '%" + key + "%'  or  atremark2 like '%" + key + "%'  or  atprice like '%" + key + "%'  or  atsell like '%" + key + "%'  or  aturl like '%" + key + "%'  or  atlike  like '%" + key + "%'   ) ";
            string sql3 = string.IsNullOrEmpty(type1) ? "" : " and attype1=" + type1;
            string sql4 = string.IsNullOrEmpty(type2) ? "" : " and attype2= '" + type2 + "' ";
        ...
        public static SqlParameter[] GetSqlParameters(aotunew_title aotunew_titleExample)
        {
            List<SqlParameter> list_param = new List<SqlParameter>();

            if (!string.IsNullOrEmpty(aotunew_titleExample.attitle))
            {
                list_param.Add(new SqlParameter("@attitle", aotunew_titleExample.attitle));
            }
            else
            {
                list_param.Add(new SqlParameter("@attitle", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(aotunew_titleExample.atjieshao))
            {
                list_param.Add(new SqlParameter("@atjieshao", aotunew_titleExample.atjieshao));
            }
            else
            {
                list_param.Add(new SqlParameter("@atjieshao", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(aotunew_titleExample.attype1))
            {
                list_param.Add(new SqlParameter("@attype1", aotunew_titleExample.attype1));
            }
            else
            {
                list_param.Add(new SqlParameter("@attype1", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(aotunew_titleExample.attype2))
            {
                list_param.Add(new SqlParameter("@attype2", aotunew_titleExample.attype2));
            }
            else
            {
                list_param.Add(new SqlParameter("@attype2", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(aotunew_titleExample.atremark1))
            {
                list_param.Add(new SqlParameter("@atremark1", aotunew_titleExample.atremark1));
            }
            else
            {
                list_param.Add(new SqlParameter("@atremark1", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(aotunew_titleExample.atremark2))
            {
                list_param.Add(new SqlParameter("@atremark2", aotunew_titleExample.atremark2));
            }
            else
            {
                list_param.Add(new SqlParameter("@atremark2", DBNull.Value));
            }
            if (aotunew_titleExample.atdate != new DateTime() && aotunew_titleExample.atdate != null)
            {
                list_param.Add(new SqlParameter("@atdate", aotunew_titleExample.atdate.ToString("yyyy-MM-dd")));
            }
            else
            {
                list_param.Add(new SqlParameter("@atdate", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(aotunew_titleExample.atprice))
            {
                list_param.Add(new SqlParameter("@atprice", aotunew_titleExample.atprice));
            }
            else
            {
                list_param.Add(new SqlParameter("@atprice", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(aotunew_titleExample.atsell))
            {
                list_param.Add(new SqlParameter("@atsell", aotunew_titleExample.atsell));
            }
            else
            {
                list_param.Add(new SqlParameter("@atsell", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(aotunew_titleExample.aturl))
            {
                list_param.Add(new SqlParameter("@aturl", aotunew_titleExample.aturl));
            }
            else
            {
                list_param.Add(new SqlParameter("@aturl", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(aotunew_titleExample.atlike))
            {
                list_param.Add(new SqlParameter("@atlike", aotunew_titleExample.atlike));
            }
            else
            {
                list_param.Add(new SqlParameter("@atlike", DBNull.Value));
            }
        ...
        public static aotunew_title GetByReader(SqlDataReader Reader)
        {
