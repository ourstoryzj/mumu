...
namespace DAL
{
    ...
    public class keys_tiaojianService : Ikeys_tiaojianService
    {
        ...
        {
            string sql1 = "select top " + (e - s + 1).ToString() + " * from keys_tiaojian where ";
            string sql2 = string.IsNullOrEmpty(key) ? " 1=1 " : " ( kstate like '%" + key + "%' or klevel like '%" + key + "%' or kname like '%" + key + "%' or kremark1 like '%" + key + "%' or kremark2 like '%" + key + "%' or kremark3 like '%" + key + "%' or kremark4 like '%" + key + "%'  )";//删除无用字段，删除最后一个or
            string sql3 = string.IsNullOrEmpty(state) ? "" : " and kstate= '" + state + "' ";//状态字段，无用删除
            string sql33 = string.IsNullOrEmpty(level) ? "" : " and klevel= '" + level + "' ";
            string sql4 = id == 0 ? "" : " and ktid='" + id.ToString() + "' ";//Int字段，无用删除
            ...
            string sql8 = s == 1 ? "" : " and ktid not in ( select top " + (s - 1).ToString() + " ktid from keys_tiaojian where " + sql2 + sql3 + sql33 + sql4 + sql5 + sql6 + sql7 + " ) ";
            DBHelper.sqlstr = sql1 + sql2 + sql3 + sql33 + sql4 + sql5 + sql6 + sql8 + sql7;
            List<keys_tiaojian> list = new List<keys_tiaojian>();
            SqlDataReader reader = DBHelper.ExecuteReader();
            while (reader.Read())
            {
        ...
        public static SqlParameter[] GetSqlParameters(keys_tiaojian keys_tiaojianExample)
        {
            List<SqlParameter> list_param = new List<SqlParameter>();
            if (keys_tiaojianExample.klength1 != 0)
            {
                list_param.Add(new SqlParameter("@klength1", keys_tiaojianExample.klength1));
            }
            else
            {
                list_param.Add(new SqlParameter("@klength1", DBNull.Value));
            }
            if (keys_tiaojianExample.klength2 != 0)
            {
                list_param.Add(new SqlParameter("@klength2", keys_tiaojianExample.klength2));
            }
            else
            {
                list_param.Add(new SqlParameter("@klength2", DBNull.Value));
            }
            if (keys_tiaojianExample.kdianjilv1 != new decimal())
            {
                list_param.Add(new SqlParameter("@kdianjilv1", keys_tiaojianExample.kdianjilv1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kdianjilv1", DBNull.Value));
            }
            if (keys_tiaojianExample.kdianjilv2 != new decimal())
            {
                list_param.Add(new SqlParameter("@kdianjilv2", keys_tiaojianExample.kdianjilv2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kdianjilv2", DBNull.Value));
            }
            if (keys_tiaojianExample.kdianjishu1 != 0)
            {
                list_param.Add(new SqlParameter("@kdianjishu1", keys_tiaojianExample.kdianjishu1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kdianjishu1", DBNull.Value));
            }
            if (keys_tiaojianExample.kdianjishu2 != 0)
            {
                list_param.Add(new SqlParameter("@kdianjishu2", keys_tiaojianExample.kdianjishu2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kdianjishu2", DBNull.Value));
            }
            if (keys_tiaojianExample.kgoodsnum1 != 0)
            {
                list_param.Add(new SqlParameter("@kgoodsnum1", keys_tiaojianExample.kgoodsnum1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kgoodsnum1", DBNull.Value));
            }
            if (keys_tiaojianExample.kgoodsnum2 != 0)
            {
                list_param.Add(new SqlParameter("@kgoodsnum2", keys_tiaojianExample.kgoodsnum2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kgoodsnum2", DBNull.Value));
            }
            if (keys_tiaojianExample.krenqi1 != 0)
            {
                list_param.Add(new SqlParameter("@krenqi1", keys_tiaojianExample.krenqi1));
            }
            else
            {
                list_param.Add(new SqlParameter("@krenqi1", DBNull.Value));
            }
            if (keys_tiaojianExample.krenqi2 != 0)
            {
                list_param.Add(new SqlParameter("@krenqi2", keys_tiaojianExample.krenqi2));
            }
            else
            {
                list_param.Add(new SqlParameter("@krenqi2", DBNull.Value));
            }
            if (keys_tiaojianExample.kshangcheng1 != new decimal())
            {
                list_param.Add(new SqlParameter("@kshangcheng1", keys_tiaojianExample.kshangcheng1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kshangcheng1", DBNull.Value));
            }
            if (keys_tiaojianExample.kshangcheng2 != new decimal())
            {
                list_param.Add(new SqlParameter("@kshangcheng2", keys_tiaojianExample.kshangcheng2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kshangcheng2", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCprice1 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCprice1", keys_tiaojianExample.kZTCprice1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCprice1", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCprice2 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCprice2", keys_tiaojianExample.kZTCprice2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCprice2", DBNull.Value));
            }
            if (keys_tiaojianExample.kzhuanhualv1 != new decimal())
            {
                list_param.Add(new SqlParameter("@kzhuanhualv1", keys_tiaojianExample.kzhuanhualv1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kzhuanhualv1", DBNull.Value));
            }
            if (keys_tiaojianExample.kzhuanhualv2 != new decimal())
            {
                list_param.Add(new SqlParameter("@kzhuanhualv2", keys_tiaojianExample.kzhuanhualv2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kzhuanhualv2", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCzhanxian1 != 0)
            {
                list_param.Add(new SqlParameter("@kZTCzhanxian1", keys_tiaojianExample.kZTCzhanxian1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCzhanxian1", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCzhanxian2 != 0)
            {
                list_param.Add(new SqlParameter("@kZTCzhanxian2", keys_tiaojianExample.kZTCzhanxian2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCzhanxian2", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCdianjishu1 != 0)
            {
                list_param.Add(new SqlParameter("@kZTCdianjishu1", keys_tiaojianExample.kZTCdianjishu1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCdianjishu1", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCdianjishu2 != 0)
            {
                list_param.Add(new SqlParameter("@kZTCdianjishu2", keys_tiaojianExample.kZTCdianjishu2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCdianjishu2", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCdianjilv1 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCdianjilv1", keys_tiaojianExample.kZTCdianjilv1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCdianjilv1", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCdianjilv2 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCdianjilv2", keys_tiaojianExample.kZTCdianjilv2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCdianjilv2", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCzhuanhualv1 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCzhuanhualv1", keys_tiaojianExample.kZTCzhuanhualv1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCzhuanhualv1", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCzhuanhualv2 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCzhuanhualv2", keys_tiaojianExample.kZTCzhuanhualv2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCzhuanhualv2", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCjunjia1 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCjunjia1", keys_tiaojianExample.kZTCjunjia1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCjunjia1", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCjunjia2 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCjunjia2", keys_tiaojianExample.kZTCjunjia2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCjunjia2", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCjingzhengdu1 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCjingzhengdu1", keys_tiaojianExample.kZTCjingzhengdu1));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCjingzhengdu1", DBNull.Value));
            }
            if (keys_tiaojianExample.kZTCjingzhengdu2 != new decimal())
            {
                list_param.Add(new SqlParameter("@kZTCjingzhengdu2", keys_tiaojianExample.kZTCjingzhengdu2));
            }
            else
            {
                list_param.Add(new SqlParameter("@kZTCjingzhengdu2", DBNull.Value));
            }
            if (keys_tiaojianExample.kdate != new DateTime() && keys_tiaojianExample.kdate != null)
            {
                list_param.Add(new SqlParameter("@kdate", keys_tiaojianExample.kdate.ToString("yyyy-MM-dd")));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kstate", keys_tiaojianExample.kstate));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@klevel", keys_tiaojianExample.klevel));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kname", keys_tiaojianExample.kname));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kremark1", keys_tiaojianExample.kremark1));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kremark2", keys_tiaojianExample.kremark2));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kremark3", keys_tiaojianExample.kremark3));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kremark4", keys_tiaojianExample.kremark4));
            }
            else
            {
        ...
        public static keys_tiaojian GetByReader(SqlDataReader Reader)
        {
