...
namespace DAL
{
    ...
    public class yh_keysService : Iyh_keysService
    {
        ...
        public IList<yh_keys> Search(int s, int e, string key, int ckid, decimal kdgbbsscs1, decimal kdgbbsscs2, decimal kdianjilv1, decimal kdianjilv2, int kdianjizhishu1, int kdianjizhishu2, int kgoodsnum1, int kgoodsnum2, decimal kqgbbcjcs1, decimal kqgbbcjcs2, int krenshu1, int krenshu2, decimal kscdianjizhanbi1, decimal kscdianjizhanbi2, decimal ksousuozhanbi1, decimal ksousuozhanbi2, decimal kzhitongche1, decimal kzhitongche2, decimal kzhuanhualv1, decimal kzhuanhualv2, int kcishu1, int kcishu2, string state, string state2, string state3, DateTime dt1_add, DateTime dt2_add, string orderby)
        {
            ...
            DBHelper.sqlstr = sql1 + sql2 + sql3 + sql4 + sql5 + sql6 + sql7 + sql8 + sql9 + sql10 + sql11 + sql12 + sql13 + sql14 + sql15 + sql16 + sql17 + sql18 + sql19 + sql20 + sql21 + sql22 + sql23 + sql24 + sql25 + sql26 + sql27 + sql30 + sql29 + sql28;
            List<yh_keys> list = new List<yh_keys>();
            SqlDataReader reader = DBHelper.ExecuteReader();
            while (reader.Read())
            {
        ...
        public static SqlParameter[] GetSqlParameter(yh_keys yh_keysExample)
        {
            List<SqlParameter> list_param = new List<SqlParameter>();
            if (yh_keysExample.ckid != 0)
            {
                list_param.Add(new SqlParameter("@ckid", yh_keysExample.ckid));
            }
            else
            {
                list_param.Add(new SqlParameter("@ckid", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(yh_keysExample.k_standby1))
            {
                list_param.Add(new SqlParameter("@k_standby1", yh_keysExample.k_standby1));
            }
            else
            {
                list_param.Add(new SqlParameter("@k_standby1", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(yh_keysExample.k_standby2))
            {
                list_param.Add(new SqlParameter("@k_standby2", yh_keysExample.k_standby2));
            }
            else
            {
                list_param.Add(new SqlParameter("@k_standby2", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(yh_keysExample.k_standby3))
            {
                list_param.Add(new SqlParameter("@k_standby3", yh_keysExample.k_standby3));
            }
            else
            {
                list_param.Add(new SqlParameter("@k_standby3", DBNull.Value));
            }
            if (yh_keysExample.kcishu != 0)
            {
                list_param.Add(new SqlParameter("@kcishu", yh_keysExample.kcishu));
            }
            else
            {
                list_param.Add(new SqlParameter("@kcishu", DBNull.Value));
            }
            if (yh_keysExample.kdgbbsscs != new decimal())
            {
                list_param.Add(new SqlParameter("@kdgbbsscs", yh_keysExample.kdgbbsscs));
            }
            else
            {
                list_param.Add(new SqlParameter("@kdgbbsscs", DBNull.Value));
            }
            if (yh_keysExample.kdianjilv != new decimal())
            {
                list_param.Add(new SqlParameter("@kdianjilv", yh_keysExample.kdianjilv));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kdianjizhishu", yh_keysExample.kdianjizhishu));
            }
            else
            {
                list_param.Add(new SqlParameter("@kdianjizhishu", DBNull.Value));
            }
            if (yh_keysExample.kgoodsnum != 0)
            {
                list_param.Add(new SqlParameter("@kgoodsnum", yh_keysExample.kgoodsnum));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kname", yh_keysExample.kname));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kqgbbcjcs", yh_keysExample.kqgbbcjcs));
            }
            else
            {
                list_param.Add(new SqlParameter("@kqgbbcjcs", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(yh_keysExample.kremark))
            {
                list_param.Add(new SqlParameter("@kremark", yh_keysExample.kremark));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@krenshu", yh_keysExample.krenshu));
            }
            else
            {
                list_param.Add(new SqlParameter("@krenshu", DBNull.Value));
            }
            if (yh_keysExample.kscdianjizhanbi != new decimal())
            {
                list_param.Add(new SqlParameter("@kscdianjizhanbi", yh_keysExample.kscdianjizhanbi));
            }
            else
            {
                list_param.Add(new SqlParameter("@kscdianjizhanbi", DBNull.Value));
            }
            if (yh_keysExample.ksousuozhanbi != new decimal())
            {
                list_param.Add(new SqlParameter("@ksousuozhanbi", yh_keysExample.ksousuozhanbi));
            }
            else
            {
                list_param.Add(new SqlParameter("@ksousuozhanbi", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(yh_keysExample.kstate))
            {
                list_param.Add(new SqlParameter("@kstate", yh_keysExample.kstate));
            }
            else
            {
            ...
            {
                list_param.Add(new SqlParameter("@kzhitongche", yh_keysExample.kzhitongche));
            }
            else
            {
                list_param.Add(new SqlParameter("@kzhitongche", DBNull.Value));
            }
            if (yh_keysExample.kzhuanhualv != new decimal())
            {
                list_param.Add(new SqlParameter("@kzhuanhualv", yh_keysExample.kzhuanhualv));
            }
            else
            {
        ...
        public static yh_keys GetByReader(SqlDataReader Reader)
        {
