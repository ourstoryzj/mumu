...
namespace DAL.Access
{
    ...
    public class goodsService : IgoodsService
    {
        ...
        {
            Access.DBHelper.sqlstr = "select * from goods ";
        ...
        {
            Access.DBHelper.sqlstr = "select * from goods where gid = @gid";
            OleDbParameter[] param = new OleDbParameter[] {
                new OleDbParameter("@gid",gid)
			};
        ...
        {
            Access.DBHelper.sqlstr = "insert into  goods (g_price_yuan,g_standby1,g_standby2,g_standby3,gdate,gdate1,gdate2,gdate3,gimg,gimg2,gname,gprice1,gprice2,gremark1,gremark2,gstate,gstate1,gstate2,gstate3,gtid,gtitle,gurl,gurl_yuan,gurl2)values(@g_price_yuan,@g_standby1,@g_standby2,@g_standby3,'" + goodsExample.gdate.ToString() + "','" + goodsExample.gdate1.ToString() + "','" + goodsExample.gdate2.ToString() + "','" + goodsExample.gdate3.ToString() + "',@gimg,@gimg2,@gname,@gprice1,@gprice2,@gremark1,@gremark2,@gstate,@gstate1,@gstate2,@gstate3,@gtid,@gtitle,@gurl,@gurl_yuan,@gurl2)";
            return Access.DBHelper.ExecuteNonQuery(GetOleDbParameter(goodsExample));
        }
        #endregion
        ...
        {
            Access.DBHelper.sqlstr = "update goods set g_price_yuan=@g_price_yuan,g_standby1=@g_standby1,g_standby2=@g_standby2,g_standby3=@g_standby3,gdate='" + goodsExample.gdate.ToString() + "',gdate1='" + goodsExample.gdate1.ToString() + "',gdate2='" + goodsExample.gdate2.ToString() + "',gdate3='" + goodsExample.gdate3.ToString() + "',gimg=@gimg,gimg2=@gimg2,gname=@gname,gprice1=@gprice1,gprice2=@gprice2,gremark1=@gremark1,gremark2=@gremark2,gstate=@gstate,gstate1=@gstate1,gstate2=@gstate2,gstate3=@gstate3,gtid=@gtid,gtitle=@gtitle,gurl=@gurl,gurl_yuan=@gurl_yuan,gurl2=@gurl2 where gid=" + goodsExample.gid;
            return Access.DBHelper.ExecuteNonQuery(GetOleDbParameter(goodsExample));
        }
        #endregion
        ...
        {
            Access.DBHelper.sqlstr = "delete from goods where gid =@gid";
            OleDbParameter[] param = new OleDbParameter[] {
                new OleDbParameter("@gid",gid)
			};
        ...
        public int SearchNum(string key, int gt, string state_img, string state_up, string state_title, string hasImg_tb, string hasImg_mgj, DateTime dt1_add, DateTime dt2_add, string important)
        {
            ...
            Access.DBHelper.sqlstr = sql1 + sql2 + sql3 + sql4 + sql5 + sql6 + sql7 + sql8 + sql9 + sql10;
        ...
        public IList<goods> Search(int s, int e, string key, int gt, string state_img, string state_up, string state_title, string hasImg_tb, string hasImg_mgj, DateTime dt1_add, DateTime dt2_add, string important)
        {
            ...
            string sql10 = dt2_add == new DateTime() ? "" : " and datediff('d','" + dt2_add.ToString() + "',gdate)<=0 ";
            string sql11 = string.IsNullOrEmpty(important) ? "" : " and g_standby1= '" + important + "' ";
            DBHelper.sqlstr = "select * from (select top " + (e - s + 1).ToString() + " * from " + "( " + sql1 + sql2 + sql3 + sql4 + sql5 + sql6 + sql7 + sql8 + sql9 + sql10 + sql11 + " order by gdate desc,gid asc ) order by gdate asc, gid desc) order by gdate desc,gid asc ";
            List<goods> list = new List<goods>();
        ...
        public static OleDbParameter[] GetOleDbParameter(goods goodsExample)
        {
            List<OleDbParameter> list_param = new List<OleDbParameter>();

            if (!string.IsNullOrEmpty(goodsExample.g_price_yuan))
            {
                list_param.Add(new OleDbParameter("@g_price_yuan", goodsExample.g_price_yuan));
            }
            else
            {
                list_param.Add(new OleDbParameter("@g_price_yuan", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.g_standby1))
            {
                list_param.Add(new OleDbParameter("@g_standby1", goodsExample.g_standby1));
            }
            else
            {
                list_param.Add(new OleDbParameter("@g_standby1", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.g_standby2))
            {
                list_param.Add(new OleDbParameter("@g_standby2", goodsExample.g_standby2));
            }
            else
            {
                list_param.Add(new OleDbParameter("@g_standby2", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.g_standby3))
            {
                list_param.Add(new OleDbParameter("@g_standby3", goodsExample.g_standby3));
            }
            else
            {
                list_param.Add(new OleDbParameter("@g_standby3", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gimg))
            {
                list_param.Add(new OleDbParameter("@gimg", goodsExample.gimg));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gimg", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gimg2))
            {
                list_param.Add(new OleDbParameter("@gimg2", goodsExample.gimg2));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gimg2", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gname))
            {
                list_param.Add(new OleDbParameter("@gname", goodsExample.gname));
            }
            else
            {
            ...
            {
                list_param.Add(new OleDbParameter("@gprice1", goodsExample.gprice1));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gprice1", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gprice2))
            {
                list_param.Add(new OleDbParameter("@gprice2", goodsExample.gprice2));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gprice2", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gremark1))
            {
                list_param.Add(new OleDbParameter("@gremark1", goodsExample.gremark1));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gremark1", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gremark2))
            {
                list_param.Add(new OleDbParameter("@gremark2", goodsExample.gremark2));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gremark2", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gstate))
            {
                list_param.Add(new OleDbParameter("@gstate", goodsExample.gstate));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gstate", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gstate1))
            {
                list_param.Add(new OleDbParameter("@gstate1", goodsExample.gstate1));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gstate1", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gstate2))
            {
                list_param.Add(new OleDbParameter("@gstate2", goodsExample.gstate2));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gstate2", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gstate3))
            {
                list_param.Add(new OleDbParameter("@gstate3", goodsExample.gstate3));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gstate3", DBNull.Value));
            }
            if (goodsExample.gtid != 0)
            {
                list_param.Add(new OleDbParameter("@gtid", goodsExample.gtid));
            }
            else
            {
            ...
            {
                list_param.Add(new OleDbParameter("@gtitle", goodsExample.gtitle));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gtitle", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gurl))
            {
                list_param.Add(new OleDbParameter("@gurl", goodsExample.gurl));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gurl", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gurl_yuan))
            {
                list_param.Add(new OleDbParameter("@gurl_yuan", goodsExample.gurl_yuan));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gurl_yuan", DBNull.Value));
            }

            if (!string.IsNullOrEmpty(goodsExample.gurl2))
            {
                list_param.Add(new OleDbParameter("@gurl2", goodsExample.gurl2));
            }
            else
            {
                list_param.Add(new OleDbParameter("@gurl2", DBNull.Value));
            }
        ...
        public static goods GetByReader(OleDbDataReader Reader)
        {
