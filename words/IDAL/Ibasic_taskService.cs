...
{
    /*IDAL*/
    public interface Ibasic_taskService
    {
        #region SearchAll
        /// <summary>
        /// 查询全部数据
        ...
        /// <returns></returns>
        /*查看是否为视图*/
        basic_task SearchByID(int btid);
        #endregion
        ...
        /// <returns>int</returns>
        int Insert(basic_task basic_taskExample);
        #endregion
        ...
        /// <param name="basic_task">basic_task表实例</param>
        /// <returns>int</returns>
        int Update(basic_task basic_taskExample);
        #endregion
        ...
        /// <returns></returns>
        int SearchNum(string key, string state, DateTime dt1_up, DateTime dt2_up, DateTime dt1_add, DateTime dt2_add);
        ...
        IList<basic_task> Search(int s, int e, string key, string state, DateTime dt1_up, DateTime dt2_up, DateTime dt1_add, DateTime dt2_add, string orderby);
        ...
        /// <param name="orderby">排序方式,直接输入order by后面的语句</param>
        /// <returns>IList<basic_goods></returns>
        IList<basic_task> Search(int s, int e, string key, string state, string chongfu, DateTime dt1_up, DateTime dt2_up, DateTime dt1_add, DateTime dt2_add, string orderby);
