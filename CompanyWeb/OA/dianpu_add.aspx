<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dianpu_add.aspx.cs"
    Inherits="OA_dianpu_add" ValidateRequest="false" %>
        ...
        <div class="c_title">
            ...
            <div class="c_t_desc">
                <ul>
                    ...
                    <li></li>
                      <li>
                        <asp:Button ID="btn_tolist" runat="server" Text="店铺列表" OnClientClick="window.location.href = 'dianpu_list.aspx';return false;" />
                    </li>
                </ul>
            </div>
        </div>
