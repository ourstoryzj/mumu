<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yh_corekeys_list.aspx.cs"
    Inherits="OA_yh_corekeys_list" ValidateRequest="false" %>
            ...
            <div class="content">
                <div class="c_title">
                    ...
                    <div class="c_t_desc">
                        <ul>
                            ...
                            <li>
                                <asp:Button ID="btn_toadd" runat="server" Text="添加核心关键词" Width="150px" OnClientClick="window.location.href = 'yh_corekeys_add.aspx';return false;" />
                            </li>
                        </ul>
                    </div>
                </div>
                <div>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="GridView1_RowCancelingEdit"
                        ...
                        OnRowUpdating="GridView1_RowUpdating" DataKeyNames="ckid,gtid,ckstate,cksort"
                        OnRowDeleting="GridView1_RowDeleting">
                        <Columns>
                            <asp:TemplateField HeaderText="序号" SortExpression="ckid">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_id" runat="server" Text='<%# Bind("ckid") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="核心关键词" SortExpression="ckname">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_name" runat="server" Text='<%# Bind("ckname") %>'> </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txt_name" runat="server" Text='<%# Bind("ckname") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemStyle Width="180px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="备注" SortExpression="ckremark">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_remark" runat="server" Text='<%# Bind("ckremark") %>'> </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txt_remark" runat="server" Text='<%# Bind("ckremark") %>' Width="300"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="排序" SortExpression="cksort">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_sort" runat="server" Text='<%# Bind("cksort") %>'> </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txt_sort" runat="server" Text='<%# Bind("cksort") %>' Width="90"></asp:TextBox>
                                </EditItemTemplate>
                                <ItemStyle Width="100px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="状态" SortExpression="shstate">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lb_state" runat="server" CommandName="state"></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle Width="100px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="录入时间" SortExpression="ckdate">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_date" runat="server" Text='<%# Convert.ToDateTime(Eval("ckdate").ToString()).ToString("yyyy年MM月dd日") %>'> </asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="100px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="操作" ShowHeader="False" ItemStyle-Font-Bold="true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink ID="hl_info" runat="server" Text="详细" NavigateUrl='<%# "yh_corekeys_add.aspx?id="+ Eval("ckid") %>'></asp:HyperLink>
