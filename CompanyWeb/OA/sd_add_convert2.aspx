<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sd_add_convert2.aspx.cs" Inherits="OA_sd_add_convert2"
        ...
        <div style="width: 450px; margin: 20px auto;">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txt_yuan" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="color: red;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Button ID="btn_saveMLS" runat="server" Text="美丽说" 
                            onclick="btn_saveMLS_Click" />
                    </td>
                </tr>
                <tr>
                    <td style="color: red;">
