<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sd_account_list.aspx.cs"
        ...
        <div class="c_title">
            ...
            <div class="c_t_desc">
                <ul>
                    ...
                    <li style="display: none;">手机号码状态
                        <asp:DropDownList ID="ddl_state_phone" runat="server">
                            <asp:ListItem Text="- 请选择 -" Value=""></asp:ListItem>
                            <asp:ListItem Text="未使用" Value="0"></asp:ListItem>
                            <asp:ListItem Text="已使用" Value="1"></asp:ListItem>
                        </asp:DropDownList>
                    ...
                    <li>
                        <asp:Button ID="btn_toadd" runat="server" Text="添加账号" OnClientClick="window.location.href = 'sd_account_add.aspx';return false;" />
                    </li>
                    <li>
            ...
            <ContentTemplate>
                <div>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="GridView1_RowCancelingEdit"
                        ...
                        OnRowUpdating="GridView1_RowUpdating" DataKeyNames="sdaid,sdastate,sdastate_phone"
                        OnRowDeleting="GridView1_RowDeleting">
                        <Columns>
                            <asp:TemplateField HeaderText="&lt;input type='checkbox' id='chk' name='chk' onclick='checkJs(this.checked);'/&gt;">
                                <ItemTemplate>
                                    <input type="checkbox" id="checkboxname" name="checkboxname" value='<%# DataBinder.Eval(Container.DataItem, "sdaid")%>'
                            ...
                            <asp:TemplateField HeaderText="账号">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_account" runat="server" Text='<%# Bind("sdaccount") %>'> </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txt_account" runat="server" Text='<%# Bind("sdaccount") %>' Width="180px"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="密码">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_pwd" runat="server" Text='<%# Bind("sdapwd") %>'> </asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txt_pwd" runat="server" Text='<%# Bind("sdapwd") %>' Width="180px"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="手机号码使用次数">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lb_state_phone" runat="server" Text='<%# Bind("sdastate_phone") %>'></asp:LinkButton>
                                </ItemTemplate>
                                <ItemStyle Width="200px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="操作时间">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_date" runat="server" Text='<%# Convert.ToDateTime(Eval("sdadate").ToString()).ToString("yyyy年MM月dd日") %>'> </asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="操作" ShowHeader="False" ItemStyle-Font-Bold="true">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink ID="hl_info" runat="server" Text="详细" NavigateUrl='<%# "sd_account_add.aspx?id="+ Eval("sdaid") %>'></asp:HyperLink>
