...
public partial class OA_basic_huodong_list : WebPage
{
    ...
    void bind()
    {
        GridView1.DataSource = BLL.basic_huodongManager.SearchAll();
        GridView1.DataBind();
    }
    #endregion
    ...
    {
        int id = Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Values["hdid"]);
        if (BLL.basic_huodongManager.Delete(id) != 1)
        {
