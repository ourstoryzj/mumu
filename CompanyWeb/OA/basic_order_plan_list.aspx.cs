...
public partial class OA_basic_order_plan_list : WebPage
{
    ...
    void bind()
    {
        GridView1.DataSource = BLL.basic_order_planManager.SearchAll();
        GridView1.DataBind();
    }
    #endregion
    ...
    {
        int id = Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Values["opid"]);
        if (BLL.basic_order_planManager.Delete(id) != 1)
        {
